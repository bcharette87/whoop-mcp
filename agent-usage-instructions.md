...
This repository includes a comprehensive GitHub Copilot configuration with custom agents and skills for AI-assisted development.
...
| **Issue Orchestrator** | `@issue-orchestrator` | Triage open GitHub issues and dispatch sub-agents to resolve them |
| **Code Reviewer** | `@code-reviewer` | Five-axis code review (correctness, readability, architecture, security, performance) |
| **Security Auditor** | `@security-auditor` | Vulnerability detection, threat modeling, OWASP Top 10 compliance |
| **Test Engineer** | `@test-engineer` | Test strategy design, coverage analysis, and the Prove-It pattern |
